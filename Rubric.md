...
* Use React for the front end. - chk

* Use GraphQL with a Node.js and Express.js server. -chk

* Use MongoDB and the Mongoose ODM for the database. -chk

* Use queries and mutations for retrieving, adding, updating, and deleting data. - system for managing payments and orders
